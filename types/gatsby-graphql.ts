...
export type HighlightPerSectionQuery = { allHighlights: { nodes: Array<(
      ...
      Pick<File, 'relativeDirectory' | 'name' | 'base' | 'extension'>
      & { childMdx?: Maybe<Pick<Mdx, 'body'>> }
    )> }, localTags: { nodes: Array<(
      Pick<File, 'relativeDirectory' | 'name' | 'base' | 'extension'>
      & { childMdx?: Maybe<Pick<Mdx, 'body'>> }
    )> }, companySections?: Maybe<{ skills?: Maybe<Array<Maybe<(
      Pick<SkillCompanySection, 'locale'>
      & { data?: Maybe<Array<Maybe<(
        Pick<CompanyTagSections, 'shortKey'>
        & { sections?: Maybe<Array<Maybe<(
          Pick<SkillTagSection, 'section'>
          & { tags?: Maybe<Array<Maybe<(
            Pick<TagEntity, 'name' | 'key' | 'count' | 'heading'>
            & { tags?: Maybe<Array<Maybe<Pick<TagEntity, 'name' | 'key' | 'count' | 'heading'>>>> }
          )>>> }
        )>>> }
      )>>> }
    )>>> }> };
